...
class ButtonLayout:
    ...
    def tab_1(calculator):
        ...
        ('0', lambda: calculator.add_to_calculation(0)), ('.', lambda: calculator.add_to_calculation('.')),
        ...
        # Special functions
            ('C', calculator.clear_field), ('<-', calculator.backward), ('(', lambda: calculator.add_to_calculation('(')), 
